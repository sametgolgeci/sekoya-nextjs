  ...
  return (
    <div>
      <Head>
        ...
        <title>Sekoya | Delta Medikal Ofisi</title>
      ...
      <main>
        ...
        <h1>Delta Medikal Ofisi</h1>
          <div className="container">
            <div className="row proje-inline">
              <div className="col-md-12 col-sm-12 col-xs-12 proje-right">
                <div className="proje-text">
                  <p>Ataköy Towers İş Merkezi’nde bulunan ofis katında ihtiyaca yönelik tasarlanan ofis ve arşiv dolapları, çalışma masaları ve fotokopi ünitesi ile fonksiyonel ve aynı zamanda estetik bir görünüm sağlanmıştır.</p>
                </div>
              </div>
              <div className="col-md-12 col-sm-12 col-xs-12">
                <div className="proje-list-less">
                  <a href="/../proje_06/DLT_01.jpg" target="_blank"><img className="proje-img" src="../proje_06/DLT_01.jpg" alt="Delta Medikal Ofisi"/></a>
                  <a href="/../proje_06/DLT_02.jpg" target="_blank"><img className="proje-img" src="../proje_06/DLT_02.jpg" alt="Delta Medikal Ofisi"/></a>
                  <a href="/../proje_06/DLT_03.jpg" target="_blank"><img className="proje-img" src="../proje_06/DLT_03.jpg" alt="Delta Medikal Ofisi"/></a>
                </div>
              </div>
            </div>
          </div>  
